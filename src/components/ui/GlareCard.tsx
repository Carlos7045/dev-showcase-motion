...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      ref={refElement}
      onPointerMove={(event) => {
        const rotateFactor = 0.3; // Reduzido para movimento mais sutil
    ...
    >
      <div className="h-full grid will-change-transform origin-center transition-transform duration-[var(--duration)] ease-[var(--easing)] [transform:rotateY(var(--r-x))_rotateX(var(--r-y))] rounded-[var(--radius)] border border-border/50 hover:[--opacity:0.4] hover:[--duration:200ms] hover:[--easing:linear] overflow-hidden">
